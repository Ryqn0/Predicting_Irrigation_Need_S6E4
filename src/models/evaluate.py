...
def evaluate_model(model, test_df: pd.DataFrame, encodings=None, config_path: str = "../configs/config.yaml"):
    """
    ...
    # Load encodings if provided, and build features for the test set


    test_df = test_df.copy()
    test_df, _ = build_final_features(test_df, encodings=encodings)
    X_test = test_df.drop(columns=["Irrigation_Need", "id"], errors="ignore")
